...
{
    public class UnvisualizedAlertsListViewModel : IPaginationInfo
    {
        public ListViewModel<Alert> UnvisualizedAlerts { get; set; }
        ...
        int IPaginationInfo.TotalResults => UnvisualizedAlerts.TotalCount;
